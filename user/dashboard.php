...
<head>
    ...
    <title>Dashboard Petugas - Web Desa Wukirsari</title>
        ...
        <div class="main-content">
            ...
            <div class="content">
                ...
                <div class="welcome-card">
                    ...
                    <p>Selamat datang di dashboard petugas Web Desa Wukirsari. Dari sini Anda dapat melihat dan
                        mengelola informasi yang ditampilkan pada website.</p>
                    <div class="info-list">
                        <div class="info-item">
                            <i class="fas fa-check-circle"></i>
                            <span>Akses ke 8 menu layanan utama</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-check-circle"></i>
                            <span>Kelola data dan informasi desa</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-check-circle"></i>
                            <span>Update informasi secara real-time</span>
                        </div>
                    </div>
                </div>
            </div>
